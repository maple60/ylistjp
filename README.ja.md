...
[`scientific_name()`](https://maple60.github.io/ylistjp/reference/scientific_name.md)、[`japanese_name_search()`](https://maple60.github.io/ylistjp/reference/japanese_name_search.md)、
...
はチェックリストの学名を返します。[`wfo_suggest()`](https://maple60.github.io/ylistjp/reference/wfo_suggest.md)
は WFO の候補名を確認し、
